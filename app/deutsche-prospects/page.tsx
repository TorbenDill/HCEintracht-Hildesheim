...
export const metadata = {
  ...
  description:
    "Deutsche Talente im College Football (NCAA Division 1) mit Kurs auf den NFL Draft 2027: Hero Kanu (Texas), Max Stege (Boise State), Justin Okoronkwo (South Carolina), Linus Zunk (Washington State) – mit deutschem Scouting-Profil, Herkunft und Draft-Aussicht.",
